...
internal sealed class CopyOnWriteDictionary<TKey, TValue>(
    ...
    where TKey : notnull
{
    ...
    private IDictionary<TKey, TValue> ReadDictionary
    {
        get
        {
            return _innerDictionary ?? sourceDictionary;
        }
    }
    ...
    private IDictionary<TKey, TValue> WriteDictionary
    {
        get
        {
            ...
            {
                _innerDictionary = new Dictionary<TKey, TValue>(sourceDictionary,
                                                                comparer);
            }
